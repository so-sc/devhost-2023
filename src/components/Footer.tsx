      ...
      <footer className="body-font tracking-wider">
        <div className="md:pt-14 pb-10 flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="flex flex-grow mb-10 mx-4 md:mx-6 md:mt-0 mt-10 ">
            <div className="lg:w-1/2 md:w-1/2 w-full px-4">
              <div className="flex text-white flex-col">
                <Link
                  className="pt-2 hover:underline w-fit underline-offset-8"
                  href={githubLink}
                  target="_blank"
                >
                  GitHub
          ...
          <div className="md:w-1/3 text-white flex-shrink-0 mx-8">
            ...
            <p className="font-bold pt-8">Sahyadri Open-Source Community</p>
            <p className="pt-2">
            ...
            <div className="mt-2 flex flex-wrap">
              <Link
                className="hover:underline w-fit mt-3 mr-5 underline-offset-8"
                target="_blank"
              ...
              <Link
                className="mt-3 w-fit hover:underline w-fit-offset-8 underline-offset-8"
